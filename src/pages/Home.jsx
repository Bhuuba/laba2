    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900">
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="text-center mb-8 sm:mb-16 animate-fade-in">
          <h1 className="text-4xl sm:text-6xl font-bold mb-4 sm:mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8 mb-8 sm:mb-16">
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 sm:p-6 transform hover:scale-105 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/20">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 sm:p-6 transform hover:scale-105 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/20">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 sm:p-6 transform hover:scale-105 transition-all duration-300 hover:shadow-xl hover:shadow-green-500/20">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 sm:p-6 transform hover:scale-105 transition-all duration-300 hover:shadow-xl hover:shadow-yellow-500/20">
            <div className="text-yellow-400 text-3xl sm:text-4xl mb-3 sm:mb-4">
              🏆
            </div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-white">
              Досягнення
        ...
        {/* CTA Section */}
        {!user && (
          <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-4 sm:p-8 mb-8 sm:mb-16">
            <div className="relative z-10">
              ...
              <Link
                to="/profile"
                className="inline-block bg-white text-blue-600 px-6 sm:px-8 py-2 sm:py-3 rounded-xl font-semibold hover:bg-blue-50 transform hover:scale-105 transition-all duration-300 text-sm sm:text-base"
              >
        ...
        <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-4 sm:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-green-500 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <div className="relative bg-white/10 p-4 sm:p-6 rounded-xl z-10 transform group-hover:translate-y-[-5px] transition-all duration-300">
                <div className="text-2xl sm:text-3xl mb-3 sm:mb-4">1</div>
                <h4 className="text-lg sm:text-xl font-semibold mb-2 text-white">
                  Вибір завдання
                </h4>
                <p className="text-sm sm:text-base text-gray-400">
                  Оберіть завдання відповідно до вашого рівня та інтересів
                </p>
              </div>
            </div>
            <div className="relative group">
